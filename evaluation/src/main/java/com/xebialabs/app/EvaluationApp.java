package com.xebialabs.app;

import com.xebialabs.app.config.ApplicationProperties;
import com.xebialabs.app.config.DefaultProfileUtil;
...
public class EvaluationApp {
    ...
    public EvaluationApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(EvaluationApp.class);
